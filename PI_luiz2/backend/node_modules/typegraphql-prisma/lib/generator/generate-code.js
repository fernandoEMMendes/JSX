...
async function generateCode(dmmf, baseOptions, log = helpers_1.noop) {
    ...
    const options = {
        ...
        absolutePrismaOutputPath: !baseOptions.customPrismaImportPath &&
            ...
            ? "@prisma/client"
            : undefined,
        formatGeneratedCode: (_b = baseOptions.formatGeneratedCode) !== null && _b !== void 0 ? _b : "tsc", // default for backward compatibility
    };
    const baseDirPath = options.outputDirPath;
    const emitTranspiledCode = (_c = options.emitTranspiledCode) !== null && _c !== void 0 ? _c : options.outputDirPath.includes("node_modules");
