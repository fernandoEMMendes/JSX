...
import { somarPedidosItemController } from './Controller/Pedidos_item/somarPedidosItemController'
...
router.put("/AdicionarPedido", new AdicionarPedidoController().handle)
